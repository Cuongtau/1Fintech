...
"version"],[/(sunos)\s?([\w\.]+\d)*/i],[["name","Solaris"],"version"],[/\s([frentopc-]{0,4}bsd|dragonfly)\s?([\w\.]+)*/i],["name","version"],[/(ip[honead]+)(?:.*os\s([\w]+)*\slike\smac|;\sopera)/i],[["name","iOS"],["version",/_/g,"."]],[/(mac\sos\sx)\s?([\w\s\.]+\w)*/i,/(macintosh|mac(?=_powerpc)\s)/i],[["name","Mac OS"],["version",/_/g,"."]],[/((?:open)?solaris)[\/\s-]?([\w\.]+)*/i,/(haiku)\s(\w+)/i,/(aix)\s((\d)(?=\.|\)|\s)[\w\.]*)*/i,/(plan\s9|minix|beos|os\/2|amigaos|morphos|risc\sos|openvms)/i,
    ...
    if (!(this instanceof q)) return (new q(a, c)).getResult(); var h = a || (g && g.navigator && g.navigator.userAgent ? g.navigator.userAgent : ""), b = c ? f.extend(p, c) : p; this.getBrowser = function () { var a = n.apply(this, b.browser); a.major = f.major(a.version); return a }; this.getCPU = function () { return n.apply(this, b.cpu) }; this.getDevice = function () { var a = n.apply(this, b.device); if (void 0 === a.model) { var c = g.navigator.userAgent.toLowerCase(); /ipad/i.test(c) ? a.model = a.type = "ipad" : /iphone/i.test(c) ? a.model = "iphone" : /ipod/i.test(c) ? a.model = "ipod" : /android/i.test(c) ? a.model = "android" : /blackberry/i.test(c) ? a.model = "blackberry" : /webos/i.test(c) ? a.model = "webos" : /windows phone/i.test(c) ? a.model = "WindowsPhone" : a.model = a.type = "PC" } return a};this.getEngine=function(){return n.apply(this,b.engine)};this.getOS=function(){return n.apply(this,
